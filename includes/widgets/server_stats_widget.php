...
class Server_Stats_Widget extends WP_Widget
{
    ...
    function enqueue_script(){
        if(apply_filters('vibebp_enqueue_profile_script',false)){
            wp_enqueue_script('server_stats_widget', VIBEBP_PLUGIN_URL.'/assets/js/widgets/server_stats.js', array('wp-element', 'wp-data'), WPLMS_DASHBOARD_VERSION,true);
            wp_enqueue_style('server_stats_widget',VIBEBP_PLUGIN_URL.'/assets/css/widgets/server_stats.css',array(),WPLMS_DASHBOARD_VERSION);
