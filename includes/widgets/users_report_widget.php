...
class Users_Report_Widget extends WP_Widget
{
    ...
    function enqueue_script(){
        if(apply_filters('vibebp_enqueue_profile_script',false)){
            wp_enqueue_script('users_report_widget', VIBEBP_PLUGIN_URL.'/assets/js/widgets/users_report.js', array('wp-element', 'wp-data'), WPLMS_DASHBOARD_VERSION,true);
            wp_enqueue_style('users_report_widget',VIBEBP_PLUGIN_URL.'/assets/css/widgets/users_report.css',array(),WPLMS_DASHBOARD_VERSION);
